...
const embed = {
  ...
  "fields": [
    {
      "name": "\n»———— [March 11] ————«\nWeb Development/Web Programming\nCreate an interactive non-linear Hypertext story using HTML and CSS\n",
    ...
    {
      "name": "»———— **[TBA]** ————«\nIdeation and CPS/Creative Strategies",
      "value": "No details yet\n[Click for cat](https://preview.redd.it/tyciywgee3521.jpg?width=960&crop=smart&auto=webp&s=3d1e3a50ddca713d9019445357cff444b829c7f2)"
    },
    {
